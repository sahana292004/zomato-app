...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (restCount != null && restCount == 0) {
            ...
            int meghanaId = jdbc.queryForObject("SELECT id FROM restaurants WHERE name = 'Meghana Foods'", Integer.class);
            ...
            int leonsId = jdbc.queryForObject("SELECT id FROM restaurants WHERE name = 'Leon\\'s Burgers'", Integer.class);
            ...
            int cornerId = jdbc.queryForObject("SELECT id FROM restaurants WHERE name = 'Corner House'", Integer.class);
            ...
            int pizzaId = jdbc.queryForObject("SELECT id FROM restaurants WHERE name = 'Pizza Hut'", Integer.class);
            ...
            int empireId = jdbc.queryForObject("SELECT id FROM restaurants WHERE name = 'Empire Restaurant'", Integer.class);
